mapping = {
    ...
    'Source IP': 'Source_IP',                      # 源IP地址
    'Source Port': 'Source_Port',                  # 源端口
    'Destination IP': 'Destination_IP',            # 目标IP地址
    'Destination Port': 'Destination_Port',        # 目标端口
    'Protocol': 'Protocol',                        # 协议
    'Timestamp': 'Timestamp',                      # 时间戳
    'Flow Duration': 'Flow_Duration',              # 流量持续时间
    'Total Fwd Packets': 'Total_Fwd_Packets',      # 总前向数据包数
    'Total Backward Packets': 'Total_Backward_Packets',  # 总后向数据包数
    'Total Length of Fwd Packets': 'Total_Length_of_Fwd_Packets',  # 前向数据包总长度
    'Total Length of Bwd Packets': 'Total_Length_of_Bwd_Packets',  # 后向数据包总长度
    ...
    'CWE Flag Count': 'CWR_Flag_Count',                  # CWE标志计数
    ...
    'Init_Win_bytes_forward': 'Init_Win_bytes_forward',  # 前向初始窗口字节数
    'Init_Win_bytes_backward': 'Init_Win_bytes_backward',  # 后向初始窗口字节数
    'act_data_pkt_fwd': 'act_data_pkt_fwd',              # 前向实际数据包数
    'min_seg_size_forward': 'min_seg_size_forward',      # 前向最小段大小
